          ...
          >
            ...
            <Page number="">
              <div className="intro-page">
                ...
                <p>
                  Welcome to my technical logbook. Here I document the evolution
                  of my engineering skills through the vast expanse of
                  technology.
                </p>
            ...
            <Page number="1">
              <div className="timeline-page">
                <h2 className="page-header">
                  <Rocket size={18} /> The Ignition
                </h2>
                <div className="timeline-content">
                  <div className="year">2022 - 2024</div>
                  <h3>Graduaat Programmeren</h3>
                  <p>
                    Howest Kortrijk. Building the core foundation in C#, Java &
                    Web.
                  </p>
                </div>
              </div>
            ...
            <Page number="2">
              <div className="timeline-page">
                ...
                <div className="timeline-content">
                  ...
                  <h3>Bachelor TI</h3>
                  <p>
                    Specializing in Software Engineering. Short-track traject.
                  </p>
                </div>
              </div>
            </Page>
            ...
            <Page number="3">
              <div className="internship-page">
                <h2 className="page-header">
                  <Terminal size={18} /> Mission: Vanden Broele
                </h2>
                <div className="achievement-card">
                  <p className="role">Internship Software Engineer</p>
                  <span className="desc">
                    Optimizing data indexing & search capabilities.
                  </span>
                </div>
              </div>
            </Page>
            ...
            <Page number="4">
              <div className="internship-page">
                ...
                <div className="spec-box">
                  <Zap size={14} /> OpenSearch
                </div>
                <p className="log-text">
                  Implemented high-performance search queries and indexing
            ...
            <Page number="5">
              <div className="future-page">
                <h2>Next Horizon</h2>
                <p>
                  Seeking new challenges in complex software systems and cloud
                  architecture.
                </p>
